...
if(!empty($idn)){
	if(mysql_query("UPDATE ".$qs_db['news']." SET news_status='1' WHERE news_id='".$idn."' AND news_ownerid='".$user['id']."'")){
		qs_redirect(400, 'admin.php');
	}
}
if(!empty($ida)){
	if(mysql_query("UPDATE ".$qs_db['articles']." SET article_status='1' WHERE article_id='".$ida."' AND article_page='1' AND article_ownerid='".$user['id']."'")){
		qs_redirect(400, 'admin.php');
	}
}
